...
config = {
	...
	"httpsPort": 4001,
	"verbose": true,
	"ownershipApi": "http://localhost/ownership-api/v1/list/?type={0}&accessToken={1}",
	"personalDataDelegatedApi": "http://localhost:8080/datamanager/api/v1/username/{0}/delegated?accessToken={1}&sourceRequest={2}&sourceId={3}",
